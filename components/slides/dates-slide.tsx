  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto w-full">
        ...
        {/* Title */}
        <h2 className="slide-animate text-3xl sm:text-4xl md:text-5xl font-medium tracking-tight text-foreground mb-8 sm:mb-12">
            ...
            >
              <div
                className={`font-mono text-xs mb-2 sm:mb-3 ${
                  item.current ? "text-foreground" : "text-neutral-600"
                }`}
              >
                {item.date}
              </div>
              <h3
                className={`font-medium mb-1 text-sm sm:text-base ${
                  item.current ? "text-foreground" : "text-neutral-400"
                }`}
              >
                {item.hasPixelTitle ? (
        ...
        <div className="slide-animate mt-6 sm:mt-8 grid sm:grid-cols-3 gap-3 text-xs sm:text-sm">
          <div className="border border-neutral-800 bg-neutral-950/50 p-4 text-neutral-400">
            <span className="text-foreground">1 envío</span> por persona
          </div>
          <div className="border border-neutral-800 bg-neutral-950/50 p-4 text-neutral-400">
            <span className="text-foreground">Sin equipos</span> en la competencia global
          </div>
          <div className="border border-neutral-800 bg-neutral-950/50 p-4 text-neutral-400">
            <span className="text-foreground">URL de Vercel</span> requerida
          </div>
        </div>
        ...
        <div className="slide-animate mt-8 sm:mt-10 flex justify-center">
          <a
            ...
            className="inline-flex items-center gap-2 sm:gap-3 bg-foreground text-background px-6 sm:px-8 py-3 sm:py-4 font-medium hover:opacity-80 transition-opacity text-sm sm:text-base"
          >
            Enviar mi proyecto
            <svg
              className="w-4 h-4"
