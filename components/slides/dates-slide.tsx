    ...
    >
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="slide-animate mt-6 sm:mt-8 grid sm:grid-cols-3 gap-3 text-xs sm:text-sm">
          <div className="border border-border bg-background/50 p-4 text-muted-foreground">
        ...
        <div className="slide-animate mt-8 sm:mt-10 flex justify-center">
          <a
            ...
            className="inline-flex items-center gap-2 sm:gap-3 bg-foreground text-background px-6 sm:px-8 py-3 sm:py-4 font-medium hover:bg-foreground/90 transition-colors text-sm sm:text-base"
          >
            Enviar mi proyecto
            <svg
              className="w-4 h-4"
