      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {agenda.map((item, index) => (
            ...
            >
              <div className={`font-mono text-xs mb-3 sm:mb-4 ${index === 2 ? "text-foreground/85" : "text-muted-foreground"}`}>
                {item.time}
              </div>
        ...
        {/* What is v0 */}
        <div className="slide-animate mt-8 sm:mt-12 p-4 sm:p-6 border-l-2 border-border bg-background/30">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <span className="text-foreground/85">lenguaje natural</span>. Describes lo que quieres y v0 genera el código. Como hablar con un asistente que programa por ti.
          </p>
        </div>
      </div>
    </section>
