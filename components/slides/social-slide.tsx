  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto w-full text-center">
        ...
        <p className="slide-animate text-neutral-400 text-base sm:text-lg max-w-xl mx-auto mb-8 sm:mb-10 leading-relaxed px-2">
        ...
        <div className="slide-animate mb-8 sm:mb-10">
          <span className="inline-block px-6 sm:px-8 py-3 sm:py-4 border-2 border-white text-white font-mono text-xl sm:text-2xl md:text-3xl tracking-wider">
        ...
        <div className="slide-animate mb-10 sm:mb-12">
          <p className="text-neutral-600 text-xs sm:text-sm mb-3 sm:mb-4">Etiqueta a</p>
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
            <a
              href="https://twitter.com/v0"
              target="_blank"
              rel="noopener noreferrer"
              className="px-3 sm:px-4 py-2 bg-neutral-900 text-neutral-400 hover:bg-neutral-800 hover:text-white transition-colors text-xs sm:text-sm"
            >
              @v0
            </a>
            <a
        ...
        <div className="slide-animate flex justify-center gap-3 sm:gap-4 mb-12 sm:mb-16">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 sm:w-12 sm:h-12 border border-neutral-700 flex items-center justify-center text-neutral-500 hover:border-white hover:text-white transition-colors"
        ...
        {/* Footer */}
        <div className="slide-animate pt-6 sm:pt-8 border-t border-neutral-900">
          <div className="flex flex-col md:flex-row items-center justify-center gap-3 sm:gap-4 md:gap-8 text-xs sm:text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-neutral-500">Un evento de</span>
              <span className="text-white">v0 by Vercel</span>
            </div>
            <span className="text-neutral-800 hidden md:inline">|</span>
            <div className="flex items-center gap-2">
              <span className="text-neutral-500">Founding host:</span>
              <a 
