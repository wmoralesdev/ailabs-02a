      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="slide-animate grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 sm:mb-10">
          {waitReasons.map((item, index) => (
            <div key={index} className="flex items-center gap-4 p-4 border border-neutral-800">
              <div className="w-10 h-10 border border-neutral-700 flex items-center justify-center flex-shrink-0">
                {item.icon === "user" && (
              ...
              <span className="text-neutral-300 text-sm sm:text-base">{item.reason}</span>
            </div>
          ))}
        </div>
        ...
        <div className="slide-animate p-4 sm:p-6 bg-neutral-900/50 border border-neutral-800 mb-8">
          <p className="text-neutral-500 text-xs uppercase tracking-wider mb-2">Ejemplo</p>
