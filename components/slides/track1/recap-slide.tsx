  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto w-full">
        ...
        {/* Final line */}
        <div className="slide-animate p-6 sm:p-8 border-2 border-white mb-8 sm:mb-10">
        ...
        {/* Builder action */}
        <div className="slide-animate p-4 sm:p-6 border border-neutral-800 bg-neutral-900/50 mb-8">
          <p className="text-neutral-500 text-xs uppercase tracking-wider mb-2">Antes de construir, completa la oración</p>
