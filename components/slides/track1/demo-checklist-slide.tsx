      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="slide-animate grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
          {judgingLens.map((item, index) => (
            <div key={index} className="p-3 sm:p-4 border border-border text-center">
              <p className="text-foreground text-xs sm:text-sm">{item.q}</p>
            </div>
          ))}
        </div>
        ...
        <div className="slide-animate p-4 sm:p-6 border border-border bg-secondary/50">
          <p className="text-muted-foreground text-xs uppercase tracking-wider mb-2">Practica esta oración</p>
