    ...
    >
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="slide-animate mb-6 sm:mb-8">
          <p className="text-neutral-500 text-xs uppercase tracking-wider mb-3">Evita</p>
          <div className="space-y-2">
            {avoid.map((item, index) => (
              <div key={index} className="flex items-start gap-3">
                ...
                <span className="text-neutral-500 text-sm sm:text-base">{item}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="slide-animate p-4 sm:p-6 border border-neutral-800 bg-neutral-900/50">
          <p className="text-neutral-500 text-xs uppercase tracking-wider mb-2">Fórmula</p>
