      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="slide-animate mb-8 sm:mb-10 overflow-x-auto">
          <div className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm min-w-max">
            <span className="px-3 py-1.5 bg-neutral-800 text-neutral-300">Input</span>
            <span className="text-neutral-600">→</span>
            <span className="px-3 py-1.5 bg-neutral-800 text-neutral-300">Plan</span>
            <span className="text-neutral-600">→</span>
            <span className="px-3 py-1.5 bg-neutral-800 text-neutral-300">Paso 1</span>
            <span className="text-neutral-600">→</span>
            <span className="px-3 py-1.5 bg-white text-black">Espera/Aprobación</span>
            <span className="text-neutral-600">→</span>
            <span className="px-3 py-1.5 bg-neutral-800 text-neutral-300">Paso 2</span>
            <span className="text-neutral-600">→</span>
            <span className="px-3 py-1.5 bg-neutral-800 text-neutral-300">Resultado</span>
          </div>
        </div>
        ...
        <div className="slide-animate space-y-3">
          {examples.map((example, index) => (
            <div key={index} className="flex items-start gap-3">
              <span className="text-neutral-600 font-mono text-xs mt-1">{String(index + 1).padStart(2, '0')}</span>
              <span className="text-neutral-300 text-sm sm:text-base">{example}</span>
            </div>
          ))}
        </div>
